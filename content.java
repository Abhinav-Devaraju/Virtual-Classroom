...
public class content {
	...
	public static void showWindow() {
		JFrame frame = new JFrame("VIRTUAL CLASSROOM BY ABHINAV D");
		...
		btnPdf.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
        			...
        			if ((new File("C:\\Users\\Abhinav D\\Desktop\\my_pro\\pdf_t\\11.pdf")).exists()) {

        				Process p = Runtime
        				   .getRuntime()
        				   .exec("rundll32 url.dll,FileProtocolHandler C:\\Users\\Abhinav D\\Desktop\\my_pro\\pdf_t\\11.pdf");
        				p.waitFor();
